...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Terima kasih telah melaporkan pengaduan Anda. Pengaduan Anda telah kami terima dan saat ini <strong>masih menunggu</strong> untuk diproses.</p>
            
            <div class="info-box">
                <p><strong>Nomor Pengaduan:</strong> {{ $pengaduan->kode ?? '-' }}</p>
                <p><strong>No. Sambungan:</strong> {{ $pengaduan->no_sa ?? '-' }}</p>
                <p><strong>Status:</strong> <span style="color: #17a2b8; font-weight: bold;">{{ ucfirst($pengaduan->status) }}</span></p>
            </div>
            ...
            <p>Pengaduan Anda akan segera diproses oleh tim kami. Anda akan mendapatkan notifikasi selanjutnya ketika status pengaduan berubah.</p>
            
            <p>Terima kasih atas kepercayaan Anda kepada Perumda Air Minum Tbw Kotasmi.</p>
        </div>
