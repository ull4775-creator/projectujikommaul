...
<head>
    <meta charset="utf-8">
    <title>Pengaduan Sedang Diproses</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Informasi penting untuk Anda! Pengaduan Anda saat ini <strong>sedang diproses</strong> oleh tim kami.</p>
            
            <div class="info-box">
                <p><strong>Nomor Pengaduan:</strong> {{ $pengaduan->kode ?? '-' }}</p>
                <p><strong>No. Sambungan:</strong> {{ $pengaduan->no_sa ?? '-' }}</p>
                <p><strong>Status:</strong> <span style="color: #ffc107; font-weight: bold;">{{ ucfirst($pengaduan->status) }}</span></p>
            </div>
            ...
            <p>Tim kami sedang menangani pengaduan Anda. Kami akan menginformasikan kembali jika pengaduan telah selesai.</p>
